...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { artist_id: @gallery.artist_id, description: @gallery.description, name: @gallery.name } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { artist_id: @gallery.artist_id, description: @gallery.description, name: @gallery.name } }
