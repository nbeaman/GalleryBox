...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { artist_id: @art.artist_id, category_id: @art.category_id, description: @art.description, name: @art.name } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { artist_id: @art.artist_id, category_id: @art.category_id, description: @art.description, name: @art.name } }
